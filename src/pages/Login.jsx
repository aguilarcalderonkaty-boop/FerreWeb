...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Supabase requiere un email. Si el usuario ingresa solo "admin", lo convertimos a "admin@ferreapp.com"
    let loginEmail = loginUser
    if (!loginEmail.includes('@')) {
      loginEmail = `${loginEmail}@ferreapp.com`
    }

    const { error: authError } = await signIn(loginEmail, password, remember)
